...
export const translations = {
  mn: {
    ...
    uploadDesc: "Дарж сонгох эсвэл чирч оруулна уу",
    ...
    termsCheckbox:
      "Үйлчилгээний нөхцөлийг зөвшөөрч байна. Үүсгэлт эхэлсний дараа төлбөр буцаах боломжгүй гэдгийг ойлгосон.",
    payGenerate: "Төлөөд үүсгэх",
    totalPrice: "Нийт үнэ",
    presetName: "Пресет",
    receiptOrderId: "Захиалгын дугаар",
    paymentWaiting: "Төлбөрийг хүлээж байна...",
    paymentAwaitDesc: "QR уншуулсны дараа автоматаар үргэлжилнэ",
    ...
    share: "Хуваалцах",
    shareToFacebook: "Facebook-д хуваалцах",
    linkCopied: "Линк хуулагдлаа.",
