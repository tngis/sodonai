...
const faqs = [
  {
    ...
    a: "Загвараа сонгоод өөрийн зургаа оруулна. Төлбөрөө төлсний дараа AI таны зургийг боловсруулж, богино хугацаанд шинэ зураг бэлэн болно.",
  },
  {
  ...
  },
  {
    ...
    a: "Та хэтэвчээрээ эсвэл QPay-р төлж болно. Хэтэвч нь урьдчилан цэнэглэсэн үлдэгдэл бөгөөд хамгийн хурдан. QPay сонговол QR кодыг уншуулах буюу банкны апп руугаа шилжиж төлбөрөө баталгаажуулна.",
  },
  {
  ...
  },
  {
    ...
    a: "Үгүй. Таны зураг анхдагчаар нууц байна. Зөвхөн зураг үүсгэх үед “Бусдад харуулах”-ыг асаавал тухайн зураг хямдарч, нүүр хуудасны нийтийн галерейд харагдана. Дараа нь нэг удаа нууцалж болно — нууцлахдаа эдэлсэн хямдралаа буцаан төлнө. Нэг нууцалсан зургийг дахин нийтлэх боломжгүй бөгөөд нууцаар үүсгэсэн зургийг хожим нийтлэх боломжгүй.",
  },
  {
